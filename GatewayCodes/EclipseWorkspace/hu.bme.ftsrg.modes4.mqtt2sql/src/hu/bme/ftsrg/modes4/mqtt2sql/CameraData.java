  ...
  extends Data
{
  ...
  public CameraData(JsonObject json)
  {
    ...
    BoxLeft = Double.valueOf(json.get("BoxLeft").toString()).doubleValue();
    
    BoxTop = Double.valueOf(json.get("BoxTop").toString()).doubleValue();
    
    BoxRight = Double.valueOf(json.get("BoxRight").toString()).doubleValue();
    
    BoxBottom = Double.valueOf(json.get("BoxBottom").toString()).doubleValue();
    
    LowerBound = Double.valueOf(json.get("LowerBound").toString()).doubleValue();
    
    UpperBound = Double.valueOf(json.get("UpperBound").toString()).doubleValue();
  }
