...
public class RailData extends AccData
{
  ...
  {
    super(json);
    Infra1 = Integer.valueOf(json.get("Infra1").toString().substring(1, json.get("Infra1").toString().length() - 1)).intValue();
    Infra2 = Integer.valueOf(json.get("Infra2").toString().substring(1, json.get("Infra2").toString().length() - 1)).intValue();
  }
